<footer class="bg-[#2ecc71] text-white mt-8">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- Left: logo + title + description + quick links -->
            <div>
                <div class="flex items-start gap-4">
                    <img src="/images/ers-logo.png" alt="eReligiousServices" class="w-10 h-10 rounded-full object-cover" />
                    <div>
                        <div class="text-lg font-semibold">eReligiousServices</div>
                        <div class="text-xs opacity-90">HNU CREaM</div>
                        <p class="text-sm text-white/90 leading-snug max-w-xs mt-2">The Center for Religious Education and Mission serves as the hub of Catholic and Christian formation at Holy Name University, guided by the four pillars of L.O.V.E.</p>
                    </div>
                </div>
            ...
            <!-- Center: Our Services -->
            <div>
                <h4 class="text-base font-semibold mb-2">Our Services</h4>
                <ul class="space-y-1 text-sm text-white/90">
            ...
            <!-- Right: Contact CREaM -->
            <div>
                <h4 class="text-base font-semibold mb-2">Contact CREaM</h4>
                <ul class="text-sm text-white/90 space-y-2">
                    <li class="flex items-start gap-3">
                        <svg class="w-4 h-4 mt-1 text-white/90" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/></svg>
                        <div>Holy Name University<br/>Tagbilaran City, Bohol<br/>Philippines</div>
                    </li>
                    <li class="flex items-center gap-3"><svg class="w-4 h-4 text-white/90" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 5h2l2 5-2 5H3v4h3a1 1 0 001-1v-2l3-2 3 2v2a1 1 0 001 1h3v-4h-2l-2-5 2-5h2V5H3z"/></svg> +63 (38) 411-3715</li>
                    <li class="flex items-center gap-3"><svg class="w-4 h-4 text-white/90" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8.5v7A2.5 2.5 0 0 0 5.5 18h13a2.5 2.5 0 0 0 2.5-2.5v-7A2.5 2.5 0 0 0 18.5 6h-13A2.5 2.5 0 0 0 3 8.5z"></path><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.5L12 13 3 8.5"></path></svg> <a href="mailto:cream@hnu.edu.ph" class="hover:underline">cream@hnu.edu.ph</a></li>
                    <li class="flex items-start gap-3"><svg class="w-4 h-4 mt-1 text-white/90" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3"/></svg> Mon - Fri: 8:00 AM - 5:00 PM<br/>Mass: 12:00 PM</li>
                </ul>
            </div>
        </div>
