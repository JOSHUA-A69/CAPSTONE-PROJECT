    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 overflow-hidden shadow-sm sm:rounded-lg border border-yellow-200 dark:border-yellow-800">
                    <div class="p-6">
                        ...
                        <a href="{{ route('adviser.reservations.index', ['status' => 'pending']) }}" class="mt-4 inline-flex items-center text-sm font-semibold text-yellow-700 dark:text-yellow-300 hover:underline">
                            Review Requests
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 overflow-hidden shadow-sm sm:rounded-lg border border-green-200 dark:border-green-800">
                    <div class="p-6">
                        ...
                        <a href="{{ route('adviser.reservations.index', ['time' => 'upcoming']) }}" class="mt-4 inline-flex items-center text-sm font-semibold text-green-700 dark:text-green-300 hover:underline">
                            View Schedule
                            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <a href="{{ route('adviser.reservations.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-gray-100">All Requests</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">View reservations</p>
                        </div>
                    </div>
                </a>
                <a href="{{ route('adviser.notifications.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Recent updates</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">Assigned Organization</h3>
                    @if($user->organizations->isEmpty())
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">You are not assigned to any organization yet.</p>
                    ...
                    @else
                        <ul class="mt-2 space-y-2">
                            @foreach($user->organizations as $org)
                                <li class="p-4 rounded border border-gray-200 dark:border-gray-700">
                                    <div class="font-medium">{{ $org->org_name }}</div>
                                    <div class="text-sm text-gray-600 dark:text-gray-400">{{ Str::limit($org->org_desc ?? '—', 160) }}</div>
                                </li>
                            @endforeach
                        </ul>
                    @endif
