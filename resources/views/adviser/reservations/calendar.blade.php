...
@push('scripts')
<script>
    document.addEventListener('DOMContentLoaded', initializeAdviserCalendar);

    function initializeAdviserCalendar() {
        if (typeof window.Calendar === 'undefined') {
            setTimeout(initializeAdviserCalendar, 150);
            return;
        }

        const reservationNode = document.getElementById('adviser-reservations-json');
        const scheduleNode = document.getElementById('adviser-schedules-json');
        const orgBookingsNode = document.getElementById('adviser-org-bookings-json');
        const calendarHost = document.getElementById('adviserCalendar');
