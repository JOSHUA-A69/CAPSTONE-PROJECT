                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between py-2 bg-blue-50 dark:bg-blue-900/20 -mx-3 px-3 rounded">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Adviser (You)</span>
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-green-700 dark:text-green-400 mt-1">
                            You have already confirmed this cancellation request on {{ $cancellation->adviser_confirmed_at->format('M d, Y h:i A') }}.
                        </p>
                    </div>
                </div>
            </div>
