            ...
            <h1 class="text-3xl font-bold text-[#2ecc71]">Create Account</h1>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" name="email" type="email" value="{{ old('email') }}" required class="mt-2 w-full rounded-md border border-[#e3e3e0] px-4 py-3 text-base" />
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>

                    <div class="mb-4">
                        <label for="phone" class="block text-sm font-medium text-[#1b1b18]">Phone (optional)</label>
                        <input id="phone" name="phone" type="text" value="{{ old('phone') }}" class="mt-2 w-full rounded-md border border-[#e3e3e0] px-4 py-3 text-base" />
                    ...
                    <div class="mb-4">
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password" required class="mt-2 w-full rounded-md border border-[#e3e3e0] px-4 py-3 text-base" />
