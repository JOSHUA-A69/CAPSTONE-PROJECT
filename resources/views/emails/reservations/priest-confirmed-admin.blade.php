...
@section('title', 'Priest Confirmed Availability')
...
@section('content')
    ...
    <p style="margin-bottom: 20px;">
        <strong>{{ $priestName }}</strong> has CONFIRMED their availability for the following reservation:
    </p>
    ...
    <p style="margin-bottom: 20px;">
        The reservation is now approved and no further action is required at this time.
    </p>
@endsection
