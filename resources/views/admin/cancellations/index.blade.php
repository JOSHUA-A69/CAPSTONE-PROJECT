            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="space-x-2">
                            <a href="{{ route('admin.cancellations.index', ['status' => 'pending']) }}" class="px-3 py-1 rounded text-sm {{ ($status ?? 'pending') === 'pending' ? 'bg-green-600 text-white' : 'bg-gray-200 dark:bg-gray-700' }}">Pending</a>
                            <a href="{{ route('admin.cancellations.index', ['status' => 'completed']) }}" class="px-3 py-1 rounded text-sm {{ ($status ?? 'pending') === 'completed' ? 'bg-green-600 text-white' : 'bg-gray-200 dark:bg-gray-700' }}">Completed</a>
                        </div>
                    </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <a href="{{ route('admin.cancellations.show', $c->cancellation_id) }}" class="inline-flex items-center px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">
                                            Review
                                        </a>
                                    </td>
                                </tr>
