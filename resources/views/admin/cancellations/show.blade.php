    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.cancellations.confirm', $reservation->reservation_id) }}" method="POST">
                        @csrf
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Confirm Cancellation</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Confirming will mark this reservation as cancelled and notify relevant parties.</p>
                            </div>
                            <button type="submit" 
