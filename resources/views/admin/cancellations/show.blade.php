<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-red-700 dark:text-red-400 mt-1">
                            A requestor has requested to cancel their reservation. Please review and confirm.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <span class="text-sm text-gray-900 dark:text-gray-100 w-2/3">
                                {{ $cancellation->reservation->officiant?->full_name ?? $cancellation->reservation->officiant?->name ?? 'Unknown Priest' }}
                            </span>
                        </div>
                        @endif
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between py-2">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Priest</span>
            ...
            @elseif(!$cancellation->isAdminConfirmed())
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-3">
                            <form action="{{ route('admin.cancellations.reject', $cancellation->cancellation_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to reject this cancellation request?');">
                                @csrf
                                <button type="submit" 
                            ...
                            <form action="{{ route('admin.cancellations.confirm', $cancellation->cancellation_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to confirm this cancellation request?');">
                                @csrf
                                <button type="submit" 
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-green-700 dark:text-green-400 mt-1">
                            You have already confirmed this cancellation request on {{ $cancellation->admin_confirmed_at->format('M d, Y h:i A') }}.
                        </p>
                    </div>
                </div>
            </div>
