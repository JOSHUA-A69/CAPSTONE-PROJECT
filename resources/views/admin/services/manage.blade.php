                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                            <button onclick="openEditModal({{ $service->service_id }}, '{{ addslashes($service->service_name) }}', '{{ addslashes($service->description ?? '') }}')" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                Edit
                            </button>
                            <button onclick="confirmDelete({{ $service->service_id }}, '{{ addslashes($service->service_name) }}')" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300">
                                Delete
                            </button>
                        </td>
                    </tr>
