            ...
            <div class="mb-6 flex flex-wrap gap-2 justify-between items-center">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.services.calendar') }}"
                       class="px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white transition-colors">
                        📅 Calendar View
                    </a>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if($reservations->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No service assignments</h3>
                                ...
                                <div class="border dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm text-gray-600 dark:text-gray-400 mb-3">
                                        <div class="flex items-center">
                                            ...
                                            {{ $reservation->schedule_date->format('M d, Y') }} at {{ date('g:i A', strtotime($reservation->schedule_time)) }}
                                        </div>
                                    ...
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        ...
                                        @if($reservation->status === 'pending_priest_confirmation')
                                            <form method="POST" action="{{ route('admin.services.confirm', $reservation->reservation_id) }}" class="inline">
                                                @csrf
                                                <button type="submit"
