    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <a href="{{ route('staff.reservations.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-gray-100">Manage Reservations</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Review & approve requests</p>
                        </div>
                    </div>
                </a>
                <a href="{{ route('staff.organizations.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-gray-100">Manage Organizations</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Create & assign advisers</p>
                        </div>
                    </div>
                </a>
                <a href="{{ route('admin.notifications.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Latest system updates</p>
                        </div>
                    </div>
                </a>
