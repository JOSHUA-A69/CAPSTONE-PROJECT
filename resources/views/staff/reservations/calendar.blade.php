...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const rawReservations = JSON.parse(document.getElementById('staff-reservations-json').textContent || '[]');
        const rawSchedules = JSON.parse(document.getElementById('staff-schedules-json').textContent || '[]');
        ...
        const cal = new Calendar(document.getElementById('staffCalendar'), {
