                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end gap-2">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form method="POST" action="{{ route('staff.organizations.destroy', $organization->org_id) }}"
                                                          onsubmit="return confirm('Are you sure you want to delete {{ $organization->org_name }}?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
